...
import { Heart, Menu, X, Home, Info, HelpCircle, BarChart3, User, Settings, LogOut } from 'lucide-react';
        ...
        <div className="flex justify-between h-16 lg:h-20">
          ...
          <div className="lg:hidden flex items-center">
            ...
            <button
              ...
              className="ml-2 p-2 rounded-lg text-gray-700 dark:text-gray-300 hover:text-red-500 dark:hover:text-red-400 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors duration-200"
            >
                ...
                {user ? (
                  ...
                  <div className="space-y-2">
                    ...
                    <Link
                      href="/account/register"
                      onClick={() => setIsMenuOpen(false)}
                      className="block px-3 py-2 mt-2 bg-red-500 text-white rounded-lg font-medium hover:bg-red-600 transition-colors duration-200 text-center"
                    >
                      Get Started
                    </Link>
                  </div>
